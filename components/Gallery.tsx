  ...
  const goRight = () => {
    if (currentIndex != null) {
      ...
      if (currentIndex < props.images.length - 1) {
        nextIndex++;
        setModalImg(
          `https://${props.domain}/preview/${props.images[nextIndex].url}`
        );
    ...
    <>
      ...
      >
          ...
          {props.images.map((image, i) => (
            <img
              ...
              onClick={(e) => {
                ...
                setCurrentIndex(
                  parseInt(e.currentTarget.getAttribute("data-index") as string)
                );
              }}
            />
          ))}
        ...
        <div
          ...
          className={`${
            modalImg == null ? "hidden" : "block"
          } fixed z-0 flex items-center justify-center left-0 right-0 
        ...
        >
          ...
          >
            ...
            <a
              ...
              href={(modalImg as string)?.replace("preview", "fullsize")}
              target="_blank"
            >
              Open full image
            </a>
            ...
            <button
              ...
              className={`absolute -left-20 top-0 bottom-0 text-3xl ${
                currentIndex == 0 ? "text-gray-400" : ""
              }`}
              onClick={(_) => {
                goLeft();
              }}
            ...
            <button
              ...
              className={`absolute -right-20 top-0 bottom-0 text-3xl ${
                currentIndex == props.images.length - 1 ? "text-gray-400" : ""
              }`}
              onClick={(_) => {
                goRight();
              }}
